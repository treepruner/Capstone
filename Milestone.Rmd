...
#top features
News_Top_1000_Features <- rownames_to_column(as.data.frame(topfeatures(dfm(news_tokens)
        , n = 1000
        , decreasing = TRUE
        , scheme = c("count", "docfreq")
        , groups = NULL)), var = "Word")

print(News_Top_1000_Features)
...
#top features
Blogs_Top_1000_Features <- topfeatures(dfm(blogs_tokens)
        , n = 1000
        , decreasing = TRUE
        , scheme = c("count", "docfreq")
        , groups = NULL)
class(Blogs_Top_1000_Features)

print(Blogs_Top_1000_Features)
...
#top features
Twitter_Top_1000_Features <- topfeatures(dfm(twitter_tokens)
        , n = 1000
        , decreasing = TRUE
        , scheme = c("count", "docfreq")
        , groups = NULL)

print(Twitters_Top_1000_Features)
