...
ggplot(news_Top_25_dfm, aes(y = feature, x = frequency)) +
        geom_point() +
        labs( title = "Top 25 News Word Roots") +
        theme(axis.text.x = element_text(angle = 90, hjust = 1) )

# does not work
ggplot(news_Top_25_dfm, aes(x = frequency, y = feature ) +
        geom_bar(stat ="identity", color = "blue", fille = "blue") +
        labs( title = "Top 25 News Word Roots") +
        theme(axis.text.x = element_text(angle = 90, hjust = 1)))
