...
### Synopsis
This is the Milestone Report for the Coursera Data Scientist Capstone project. The project has 3 sources of text information 
* blog
* news
* twitter
that will be used to predict the most likely word to appear. The plan is to allow users to input 1 to 3 words.
